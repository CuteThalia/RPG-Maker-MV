...
(function() {
  ...
  */
  ...
  var Alias_QuasiMovement_Box_Collider_intersects = QuasiMovement.Box_Collider.prototype.intersects;
  QuasiMovement.Box_Collider.prototype.intersects = function(other) {
    if (other.depth !== this.depth) {
      if (!this.depthContains(other.depth, other.depthHeight)) {
        return false;
      }
    }
    return Alias_QuasiMovement_Box_Collider_intersects.call(this, other);
  };

  var Alias_QuasiMovement_Box_Collider_insideWithDepth = QuasiMovement.Box_Collider.prototype.insideWithDepth;
  QuasiMovement.Box_Collider.prototype.insideWithDepth = function(other) {
    if (other.depth !== this.depth) {
      if (!this.depthContains(other.depth, other.depthHeight)) {
        return false;
      }
    }
    return Alias_QuasiMovement_Box_Collider_insideWithDepth.call(this, other);
  };

  QuasiMovement.Box_Collider.prototype.depthContains = function(z1, z2) {
    if (!$gameMap.hasDepth()) {
      return true;
    }
    var zi1 = this.depth;
  ...
  Game_CharacterBase.prototype.onZoomDepthChange = function() {
    ...
    for (var i = 0; i < this._collider.length; i++) {
      if (this._collider[i]) {
        this._collider[i].scale(this._zoomDepth);
      }
    }
  };
